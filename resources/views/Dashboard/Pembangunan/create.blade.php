...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form  action="{{ route('dashboard.dokumen-pembangunan.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                  ...
                  placeholder="Masukkan Judul Dokumen Pembangunan" value="{{ old('judul') }}">
                  @error('judul')
                ...
                <div class="form-group">
                  ...
                  placeholder="Masukkan Deskripsi Dokumen Pembangunan" value="{{ old('deskripsi') }}">
                  @error('deskripsi')
                      <span  class="text-danger"> {{ $message }} </span>
                  @enderror
                </div>
