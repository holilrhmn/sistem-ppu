...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Tambah Data Tahun</h3>
        </div>
        <div class="card-body">
            <form  action="{{ route('dashboard.tahun.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                  ...
                  placeholder="Masukkan Pertanyaan" value="{{ old('tahun') }}">
                  @error('tahun')
              ...
              <div class="form-group">
                ...
                placeholder="Masukkan Pertanyaan" value="{{ old('jumlah') }}">
                @error('jumlah')
                    <span  class="text-danger"> {{ $message }} </span>
                @enderror
            </div>
