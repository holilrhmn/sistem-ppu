...
@section('title', 'Download File Excel')

@section('content')
<div class="form-inline">
    <form method="GET" action="{{route('downloadFileExcel')}}">
    <div class="form-group">
        <input placeholder="Input Nama File" name="file" type="text" id="q" class="form-control mx-sm-2">
