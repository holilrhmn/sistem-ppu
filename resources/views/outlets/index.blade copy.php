...
<div class="mb-3">
    ...
    <p class="page-title">{{ __('app.total') }} {{ __('outlet.list') }} <small> : {{ $outlets->total() }} {{ __('outlet.outlet') }}</small></p>
</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('outlets.show', $outlet) }}" id="show-outlet-{{ $outlet->nib }}">{{ __('app.show') }}</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
